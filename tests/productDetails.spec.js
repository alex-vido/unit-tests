...
describe('6 - Implemente os casos de teste para a função `productDetails`', () => {
  ...
  it('Verifica se a função `productDetails` retorna um objeto', () => {
    // Teste se o retorno da função é um array.
    expect(typeof productDetails('Alcool gel', 'Máscara')).toBe('object')
  });
  it('Verifica se a função `productDetails` retorna 2 itens', () => {
    // Teste se o array retornado pela função contém dois itens dentro.
    expect(productDetails('Alcool gel', 'Máscara')).toHaveLength(2);
  });
    // Teste se os dois itens dentro do array retornado pela função são objetos.
    it('Verifica se a função `productDetails` retorna objetos', () => {
      // Teste se quando passado parâmetros diferentes entre si, os dois objetos também são diferentes entre si.
      expect(typeof productDetails('Alcool gel', 'Máscara')).toBe('object');
    });
    // Teste se os dois productIds terminam com 123.
    it('Verifica se a função `productDetails` retorna um item com productIds que terminam com 123', () => {
